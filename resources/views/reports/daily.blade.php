            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <form method="GET" action="{{ route('reports.daily') }}" class="d-flex">
                        <input type="date" name="date" class="form-control me-2" value="{{ $selectedDate ?? date('Y-m-d') }}">
                        <button type="submit" class="btn btn-primary me-2">Filter</button>
                        <a href="{{ route('daily.print', ['date' => $selectedDate ?? date('Y-m-d')]) }}" class="btn btn-dark"><i class="bi bi-printer"></i></a>
                    </form>
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('pos.show', $order->id) }}" class="btn btn-sm btn-info">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
